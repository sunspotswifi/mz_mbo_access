...
define('MB_SITE_ID', '-99'); // INSERT_API_KEY_HERE


$endpoint_classes = 'https://api.mindbodyonline.com/public/v6/class/classes';


add_shortcode('accesstoken', 'multi_token');

function multi_token() {
	accesstoken();
}
...
class MindbodySchedule
{
  ...
  {	  
		...
		$response = wp_remote_post( 'https://api.mindbodyonline.com/public/v6/class/classes', array(
				'method' => 'GET',
				'timeout' => 45,
				'httpversion' => '1.0',
				'blocking' => true,
				'headers' => $headers,
				'body' => array( 'Username' => 'Siteowner', 
								'Password' => 'apitest1234',
								'LocationIds' => 1,
								'StartDateTime' => $range->start_date,
								'EndDateTime' => $range->end_date,
