...
class Settings_Page {
    ...
    private function access_codes(){
        ...
        $return .= "<ul>";
        $return .= "<li><strong>member_redirect</strong>: " . __("(url string) URL to redirect users to with membership (service) matching membership_types attribute.", 'mz-mindbody-api')."</li>";
